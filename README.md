...
**MIATHON’03 — theme:** *Thinking AI from Africa: ethics, power, and shared futures.*
...
| Code, DB identifiers, comments in this repo | **English** |

## Stack (backend)

Node.js, Express, Supabase (PostgreSQL). See `backend/config/schema.sql` for the data model.
